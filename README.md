...
- Current Android debug build: `versionName 1.9`, `versionCode 10`
...
```text
android/app/build/outputs/apk/debug/SquarePod-V1.9-Android-Debug.apk
```
...
```sh
adb install -r android/app/build/outputs/apk/debug/SquarePod-V1.9-Android-Debug.apk
...
```sh
adb -s <device-id> install -r android/app/build/outputs/apk/debug/SquarePod-V1.9-Android-Debug.apk
...
- 当前 Android Debug 包：`versionName 1.9`，`versionCode 10`
